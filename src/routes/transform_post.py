...
@router.post("/circle/{post_id}", response_model=PostResponse, status_code=status.HTTP_200_OK)
...
@router.post("/effect/{post_id}", response_model=PostResponse, status_code=status.HTTP_200_OK)
...
@router.post("/resize/{post_id}", response_model=PostResponse, status_code=status.HTTP_200_OK)
...
@router.post("/text/{post_id}", response_model=PostResponse, status_code=status.HTTP_200_OK)
